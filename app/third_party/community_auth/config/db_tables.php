...
$config['errors_table']                 = 'login_error';
...
// SESSION TABLES
$config['sessions_table']               = 'session';
$config['auth_sessions_table']          = 'auth_session';

// ACL
$config['acl_categories_table']         = 'acl_category';
$config['acl_actions_table']            = 'acl_action';
