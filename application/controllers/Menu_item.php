...
class Menu_item extends MY_Controller {
	...
	public function remove($menu_id, $id = '') {
		$data = array(
			...
			'link_back' => base_url('menu_item/list/' . $menu_id)
		);
	...
	public function list_all($menu_id) {
		...
		$pagy_config = array(
			'base_url' => base_url('menu_item/list/' . $menu_id)
		);
		...
		$data = array(
			...
			'link_create' => base_url('menu_item/edit/' . $menu_id)
		);
