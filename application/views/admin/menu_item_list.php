...
<tr>
	...
	<td class="command">
		<ul class="uk-iconnav">
			<li><a href="<?=base_url('/menu_item/edit/' . $row['menu_id'] . '/' . $row['id']);?>" uk-icon="icon: file-edit" title="<?=$lang->line('edit');?>"></a></li>
			<li><a href="<?=base_url('/menu_item/remove/' . $row['menu_id'] . '/' . $row['id']);?>" uk-icon="icon: trash" data-msg="<?=$lang->line('sure_to_remove');?>" title="<?=$lang->line('remove');?>" class="btn-remove"></a></li>
		</ul>
	</td>
</tr>
<?php
